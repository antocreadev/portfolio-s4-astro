        ...
        <div className="min-h-screen">
            <div className='pl-[5vw] pr-[5vw] mt-12'>
                ...
                <div class="relative">
                    ...
                    <input value={searchTerm} onChange={handleSearchChange} type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-300 focus:ring-grey-300 focus:border-grey-300 dark:bg-gray-300 dark:border-gray-300 dark:placeholder-gray-300 dark:text-gray-900 dark:focus:ring-grey-300 dark:focus:border-grey-300" placeholder="Search Mockups, Logos..." />
                </div>
            </div>
                ...
                <div className={styles.projects_all}>
                    {sortedData.map((post, key) => (
                        <div key={key} className="p-7" >
                            <div className="card w-80 md:w-[43rem] lg:w-80 bg-base-100 shadow-xl" style={{ backgroundColor: "#353e4e" }}
                            >
